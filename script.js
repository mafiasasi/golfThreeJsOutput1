...
const tree1 = new THREE.GLTFLoader(loadingManager).load(
  ...
  function (gltf) {
    ...
    treeScene.position.set(11, 0, -11);
...
markerMesh.position.x = 8;
markerMesh.scale.set(2, 2, 2);
scene.add(planeMesh);
scene.add(tubeMesh);
...
directionalLight.shadow.mapSize.x = 700;
directionalLight.shadow.mapSize.y = 700;
